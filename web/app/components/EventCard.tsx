...
export function EventCard({ event }: { event: ApiEvent }) {
  ...
  return (
    <div className="relative group">
      ...
      >
        <article className="grid grid-cols-1 items-start border-b border-rule-soft py-4 md:grid-cols-[72px_1fr_84px] md:gap-4">
          ...
          {event.event_picture_url ? (
            ...
            <div
              aria-hidden="true"
              className="hidden aspect-square border border-rule-soft bg-[repeating-linear-gradient(45deg,var(--color-rule-soft)_0_4px,transparent_4px_8px)] md:block"
            />
          )}
        </article>
      </Link>
